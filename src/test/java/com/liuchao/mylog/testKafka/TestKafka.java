package com.liuchao.mylog.testKafka;
...
public class TestKafka {
    ...
    public static void main(String[] args) {
        Producer producer = TestKafka.createProducer(
                "127.0.0.1:9092", "1", "1000",
                "gzip", "3", "5242880");
        sendKafka(producer);
       /* new Thread(new Runnable() {
        ...
        TestKafka.consumerReceived();
    }


    public static void sendKafka(Producer producer) {
    ...
    private static void consumerReceived() {
        log.info("consumerReceived start...");
